...
var Gallery = /*#__PURE__*/function (_React$Component) {
  ...
  function Gallery(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setPhotoIndex", function (index) {
      _this.setState({
  ...
  _createClass(Gallery, [{
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          ...
          lightboxPhotoIndex = _this$state.lightboxPhotoIndex;
      ...
      if (images && images.length > 0) {
        ...
        return /*#__PURE__*/_react["default"].createElement(_react.Fragment, null, /*#__PURE__*/_react["default"].createElement(_reactImageGallery["default"], {
          items: imagesArray,
        ...
        }), lightboxIsOpen && /*#__PURE__*/_react["default"].createElement(_reactImageLightbox["default"], {
          reactModalStyle: {
            overlay: {
              zIndex: 1099
            }
