...
var LoginForm = /*#__PURE__*/function (_React$Component) {
  ...
  function LoginForm(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleFormSubmit", function (values) {
      ...
      if (_this.props.location !== undefined && _this.props.location.state !== undefined) {
        if (_this.props.location.state.cartLayer && _lscache["default"].get("auth_data") === null) {
          cartLayer = true;
        }
      }
    ...
    value: function render() {
      ...
      if (this.props.state.customerProperties !== undefined) {
        if (this.props.state.customerProperties.authenticated) {
          ...
          _lscache["default"].set("auth_data", this.props.state.customerProperties.token, 6000);
        }
      }
